    ...
    return (
        <div className='bg-(--light-color) w-full flex flex-col items-center'>
            <div className='w-full flex flex-row justify-center'>
                <div className='bg-[white] w-[90vw] sm:w-[80vw] flex flex-row justify-between items-center mt-[30px] sm:mt-[50px] rounded-[10px]'>
                    <img src={mainlogo} alt="main-logo" className='rounded-[10px]' />
                    <img src={collapse} alt="collapse-icon" className='w-[3rem] rounded-[10px] mr-[10px] sm:hidden' onClick={() => setIsNav(!isNav)} />
                    ...
                    <img src={searchicon} alt="search-icon" className='hidden sm:block pr-[40px] cursor-pointer' />
                    <div
                        className={`
            ...
            <div className='w-full flex flex-col items-center sm:flex-row justify-end sm:mt-[50px]'>
                <div className='w-[90vw] sm:w-[35%]'>
                    <h1 className='text-(--dark-color) text-[40px] text-justify font-bold leading-[1.2] mt-[20px] sm:mt-[5rem]'>
                    ...
                    <p className='text-[20px] text-justify my-[10px] sm:my-[20px] text-(--txt-color)'>Nền tảng công nghệ kết nối trực tiếp với các khu vui chơi, điểm tham quan và đối tác du lịch lớn,
                    ...
                    <div className='w-[90vw] sm:w-[70%] flex flex-col bg-[#fff] rounded-[10px] mt-[20px] p-[15px]' style={{borderLeftColor: '#22D3EE', borderLeftStyle: 'solid', borderLeftWidth: '5px'}}>
                ...
                <img src={homeright} alt="home-right-img" className='w-[90vw] sm:w-[55%]' />
            </div>
        </div>
    )
}
