...
const Footer = () => {
    return (
        <div className='w-full flex flex-col'>
            <div className='bg-[#060640] w-full flex flex-row justify-end items-center pt-[10px] px-[10px]'>
                <div className='w-[25%]'>
                ...
                <img src={mapimg} alt="map-img" className='w-[35%]' />
            </div>
            <div className='bg-[#000] w-full h-[40px]'></div>
        </div>
    )
}
