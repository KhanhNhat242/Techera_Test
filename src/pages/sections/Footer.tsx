...
const Footer = () => {
    return (
        <div className='w-full flex flex-col'>
            <div className='bg-[#060640] w-full flex flex-col items-center lg:flex-row lg:justify-end lg:items-center py-[10px] px-[10px]'>
                <div className='w-[90vw] lg:w-[25%]'>
                ...
                <div className='w-[90vw] lg:w-[30%] flex flex-row justify-between mt-[20px] lg:mx-[10px]'>
                    <div>
                ...
                <img src={mapimg} alt="map-img" className='w-full my-[20px] lg:m-0 lg:w-[35%]' />
            </div>
